      ...
      >
        ...
        <span className="top-[2%] gap-[2rem] w-[85%] text-normal text-white  md:flex block text-[1.5rem] mx-auto ">
          <span className="bg-backgroundColor3 block text-center rounded-[2rem] w-full pt-[3vh] pb-[3vh] mb-[2vh] md:mb-0">
            ...
            <p className="mb-[2rem]">
              HTML, CSS, Javascript, <br /> SASS, Tailwind CSS, React JS, Vite
              JS
            </p>
          ...
          <span className="bg-backgroundColor3 block text-center rounded-[2rem] w-full pt-[3vh] pb-[3vh] mb-[2vh] md:mb-0">
            ...
            <p className="mb-[2vh]">
              Canva, Figma, Picsart, Pixellab, Phonto, <br /> Jitter, Pinpot,
          ...
          <span className="bg-backgroundColor3 block text-center rounded-[2rem] w-full pt-[3vh] pb-[3vh] mb-[2vh] md:mb-0">
            ...
            <p className="mb-[2vh]">
              Handphone, Camera, Lightroom, <br /> VSCO, Remini, Capcut, <br />
